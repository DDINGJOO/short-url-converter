...
public class RedisClickCountService implements ClickCountService {
    ...
    private void cleanupTracking(String shortCode) {
        boolean hasPending = Boolean.TRUE.equals(stringRedisTemplate.hasKey(pendingClickKey(shortCode)));
        boolean hasProcessing = Boolean.TRUE.equals(stringRedisTemplate.hasKey(processingClickKey(shortCode)));
